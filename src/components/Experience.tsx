...
export default function Experience() {
  return (
    <section id="experience" className="py-16 md:py-32 relative bg-tertiary/5 overflow-hidden">
        ...
        <div className="grid lg:grid-cols-12 gap-10 md:gap-16">
          ...
          <div className="lg:col-span-7">
            <ScrollReveal>
              ...
              <h2 className="font-display font-extrabold text-4xl md:text-7xl mb-8 md:mb-12 tracking-tighter">
          ...
          <div className="lg:col-span-5">
            <ScrollReveal delay={0.4} type="slide">
              <div className="relative">
                ...
                <div className="bg-white border-4 border-foreground p-8 md:p-12 rounded-[40px] md:rounded-[50px] h-full flex flex-col justify-between">
                  <div>
                    <div className="w-12 h-12 md:w-16 md:h-16 bg-tertiary border-4 border-foreground rounded-full flex items-center justify-center hard-shadow-active mb-6 md:mb-8 animate-bounce">
                      <Star size={24} fill="white" className="text-white md:w-8 md:h-8" />
                    </div>
                    
                    <h3 className="font-display font-black text-3xl md:text-4xl mb-4 md:mb-6 tracking-tighter uppercase italic">
                  ...
                  <div className="mt-8 md:mt-12 p-6 bg-muted border-2 border-dashed border-foreground rounded-3xl">
